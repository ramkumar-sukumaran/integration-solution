...
public class CategoryController {
	 ...
	 */
	@ApiOperation("Get Categories By UserId")
	@GetMapping("/api/v1/category") // @RequestBody Category category, 
	public ResponseEntity<?> getAllCategories(HttpServletRequest req) {
